...
setwd("/rsrch5/home/biostatistics/wzhang24/mQTL_project/codes/CAU/")
#print(paste("Current working directory:", getwd()))

source("support_MWAS.R")
#read the data
dat.wgbs.dir = "/rsrch5/home/biostatistics/wzhang24/data/WGBS/normalized_CAU/"
#data.wgs.dir = "/rsrch5/home/biostatistics/wzhang24/data/Processed_WGS/"
data.wgs.dir = "/rsrch5/home/biostatistics/wzhang24/data/Processed_data/genetic_data/CAU/dataAll/rs_tabfile/"
res.dir = "/rsrch5/home/biostatistics/chongwulab/wzhang24/MWAS/scratch_res/CAU/03-mQTL-allcis/"
res.cov.dir = "/rsrch5/home/biostatistics/wzhang24/data/Processed_data/cov/CAU/"

# if res.dir does not exist, create it
...
geno = BEDMatrix(paste0(data.wgs.dir,"CAU_1000G_chr",chr.id),simple_names=TRUE) %>% as.matrix() %>% PatchUp() %>% t()


bim = fread(paste0(data.wgs.dir,"CAU_1000G_chr",chr.id,".bim")) %>% as.data.frame()
...
### read cov
cov = read.table("/rsrch5/home/biostatistics/wzhang24/data/Processed_data/cov/CAU/cov.txt") %>% as.matrix() %>% t()
...
outfile = paste0(res.dir,"CAU_chr",chr.id,"_",indx1,".RDS")

cis_eqtls = me$cis$eqtls
saveRDS(list(cis_eqtls = cis_eqtls, cpg_list = rownames(extract)), outfile)
