...
The MWAS results are provided in our website: [gcbhub.org](https://www.gcbhub.org/)  meQTL results are provided in [https://osf.io/gct57/](https://osf.io/gct57/). DNA methylation model weights are provided in [Huggingface](https://huggingface.co/kunrzzz/Monocyte_methylation/tree/main)  
## Workflow
